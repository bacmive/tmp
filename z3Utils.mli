...
val make_z3_context : unit -> Z3.context
val and_all_exprs : Z3.context -> Z3.Expr.expr list -> Z3.Expr.expr
val z3exprToString : Z3.Expr.expr -> string
...
val bv2int : Z3.Expr.expr -> int
val get_all_models :
  Z3.context -> Expr.expr -> Expr.expr list -> int list list
val getAllModels :
  Z3.context -> Types.formula list -> Types.expression list -> int list list
